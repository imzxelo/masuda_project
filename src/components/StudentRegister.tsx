...
export default function StudentRegister({ onSuccess, onCancel }: StudentRegisterProps) {
      ...
      <Card className="max-w-md mx-auto">
        <div className="space-y-6">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-2">生徒登録確認</h2>
  ...
  return (
    <Card className="max-w-md mx-auto">
      <div className="space-y-6">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-2">生徒登録</h2>
          <p className="text-gray-600">新しい生徒を登録します</p>
        </div>
